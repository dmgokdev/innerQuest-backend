...
export const generateBussinessIdeas = asyncHandler(async (req, res) => {
	const userService = new UserService(req);
	const data = await userService.generateBussinessIdea();

	return successResponse(res, HttpStatus.OK, BUSSINESS_IDEA_GENERATED, data);
});
...
export const dashboard = asyncHandler(async (req, res) => {
	...
	return successResponse(res, HttpStatus.OK, DATA_FETCHED_SUCCESS, data);
});
